...
/**
 * Klasa umożliwiająca operację na obiekcie o podanej nazwie z pliku pqmcs/config/files/config.json
 */
class JSONObject
{
    /**
    ...
    /**
     * Pobiera plik pqcms/config/$name.json i zwraca obiekt o podanej nazwie
